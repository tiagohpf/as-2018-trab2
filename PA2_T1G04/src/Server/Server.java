...
public class Server extends javax.swing.JFrame {
    ...
    private int id;
    private ServerSocket listeningClients;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Port for request");

        jTextField3.setText("5002");

        jLabel4.setText("Queue Limit");

        jTextField4.setText("3");

        jLabel5.setText("0 = No limit");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Thread requests = new Thread() {
            public void run() {
                ...
                jButton1.setEnabled(false);
                while (true) {
                    jTextArea1.append("Server is waiting for a new request\n");
                    ...
                    CalculatePI cp = new CalculatePI(clientSocket, jTextArea1);
                    cp.start();
                }
            }
        };
